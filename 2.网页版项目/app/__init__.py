...
def creat_app():
    ...
    app = Flask(__name__, template_folder='./api_v1/templates', static_folder='./api_v1/static', static_url_path='')
    ...
    app.register_blueprint(api, url_prefix='/api/v1.0', template_folder='./api_v1/templates')
