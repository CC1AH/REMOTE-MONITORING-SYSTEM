...
class BaseConfig:
   ...
   # 配置session数据存储到redis数据库
    ...
    MAIL_USERNAME = 'duanshitong2020@163.com'  # 填邮箱
    MAIL_PASSWORD = 'UMRAEXADKDCDIDTI'      # 填授权码
    FLASK_MAIL_SENDER = 'DST树莓派系统<duanshitong2020@163.com>'   #邮件发送方
    FLASK_MAIL_SUBJECT_PREFIX = '[DST树莓派系统]'     #邮件标题
    #MAIL_DEFAULT_SENDER = 'xxx@qq.com'  # 填邮箱，默认发送者

class TestingConfig(BaseConfig):
    DEBUG = True
    LOGGING_LEVEL = logging.DEBUG
    SQLALCHEMY_DATABASE_URI = "mysql+pymysql://root:0922@127.0.0.1:3306/flask-login"
